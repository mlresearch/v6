...
abstract: Recent evaluations have indicated that in practice, general methods for
  ...
  methods for prediction which can account for such changes. We investigate some
...
id: tillman10a
month: 0
tex_title: 'When causality matters for prediction: investigating the practical tradeoffs'
firstpage: 137
lastpage: 146
page: 137-146
order: 137
